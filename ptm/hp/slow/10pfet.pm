...
*======================== process =========================*
+eot     = 7.14e-010        eotbox  = 1.4e-007        tfin    = 8e-009          toxp    = 1.26e-009      
+nbody   = 2.5e+022        phig    = 4.703391          epsrox  = 3.9             epsrsub = 11.9          
...
+qm0acc  = 0.001           pqmacc  = 0.66            delvfbacc= 0               u0      = 0.03384       
*======================== mobility ========================*
